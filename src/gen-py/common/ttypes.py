...
class PrefixSequenceType(object):
    ...
    Attributes:
     - timestamp
     - transactionid: Transaction ID set by the client in, e.g., 6LoWPAN.
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(IEEE802_1ASTimeStampType)
IEEE802_1ASTimeStampType.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'AS_sec', None, None, ),  # 1
    (2, TType.I32, 'AS_nsec', None, None, ),  # 2
)
all_structs.append(IPv4PrefixType)
IPv4PrefixType.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'address', None, None, ),  # 1
    (2, TType.BYTE, 'prefixlen', None, None, ),  # 2
)
all_structs.append(IPv6PrefixType)
IPv6PrefixType.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'address', 'BINARY', None, ),  # 1
    (2, TType.BYTE, 'prefixlen', None, None, ),  # 2
)
all_structs.append(IPAddressType)
IPAddressType.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'ipv4address', None, None, ),  # 1
    (2, TType.STRING, 'ipv6address', 'BINARY', None, ),  # 2
)
all_structs.append(IPPrefixType)
IPPrefixType.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ipv4prefix', [IPv4PrefixType, None], None, ),  # 1
    (2, TType.STRUCT, 'ipv6prefix', [IPv6PrefixType, None], None, ),  # 2
)
all_structs.append(PrefixSequenceType)
PrefixSequenceType.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'timestamp', [IEEE802_1ASTimeStampType, None], None, ),  # 1
